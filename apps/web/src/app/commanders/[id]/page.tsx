              ...
              <Card className="mt-6">
                <CardHeader className="knd-panel-header">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Top 16, Top 10, Top Cut, and 1st-place finishes from the past month (Top 4 for 34-player events).
                  </p>
                </CardHeader>
                <CardContent>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="border-border/60 text-xs uppercase tracking-[0.2em] text-muted-foreground">
                        ...
                        <TableHead className="text-right">Top 16/Top 10/Top 4s</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
