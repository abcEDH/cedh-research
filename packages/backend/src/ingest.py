...
__all__ = [
    ...
    "TopDeckClient",
    "decode_firestore_value",
    # commander_normalization — extracted from this file; re-exported so the
    # many `from ingest import clean_commander_card_name` style call sites
    # (sweep_partner_commander_order.py, backfill_moxfield_commanders.py,
    # commander_oracle_identity.py, generate_legal_commander_pairings.py, …)
