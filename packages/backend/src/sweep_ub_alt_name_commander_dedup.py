...
``repoint_tournament_entries``/``delete_commander_row`` helpers rather than
re-implementing the merge itself.
...
from sweep_partner_commander_order import delete_commander_row, repoint_tournament_entries
