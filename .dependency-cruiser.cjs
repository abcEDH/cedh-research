...
module.exports = {
  forbidden: [
    ...
    // Layering controls WHICH packages may depend on which. Add rules here.
  ],
  options: {
    doNotFollow: { path: "node_modules" },
    // Python virtual environments can contain vendored JavaScript unrelated to
    // the repository's TypeScript packages.
    exclude: { path: "(^|/)\\.venv/" },
