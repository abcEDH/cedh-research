...
| [0022](0022-hybrid-draw-model.md) | Hybrid draw model with internal Elo winner probabilities | Accepted | `packages/backend/` | PR #295 |
...
- [0024 — Vercel Python simulator trial](0024-vercel-python-simulator-trial.md): proposed; isolated invite-only deployment experiment.
